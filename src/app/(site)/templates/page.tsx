    ...
    <main className="container mx-auto px-4 py-12 pt-20">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {Object.values(TEMPLATES).map((Template: TemplateComponent) => (
          <div key={Template.metadata.id} className="rounded-lg border shadow-sm p-6 bg-white flex flex-col items-center">
            <div className="mb-4 w-full flex flex-col items-center">
              <span className="text-lg font-semibold mb-1">{Template.metadata.name}</span>
              <span className="text-gray-500 text-sm mb-2 text-center">{Template.metadata.description}</span>
            </div>
