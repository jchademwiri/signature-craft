      ...
      <div className="space-y-4">
        ...
        <Card className="p-6 bg-white border">
          <div className="space-y-2 font-sans">
            <div className="font-bold text-lg leading-tight" style={{ color: '#333333' }}>
              {data.name || 'Your Name'}
            </div>
            <div
            ...
            <div className="text-sm leading-tight">
              <span className="font-medium" style={{ color: data.primaryColor || '#0066cc' }}>
                {data.email || 'email@company.com'}
              </span>
              <span className="text-gray-400 mx-2">•</span>
              <span className="font-medium" style={{ color: data.primaryColor || '#0066cc' }}>
                {data.mobilePhone || '+27 11 123 4567'}
              </span>
            </div>
          </div>
        </Card>
